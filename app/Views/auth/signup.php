               ...
               <div class="card radius-10">
                  <div class="card-body p-4">
                     ...
                     <form class="form-body row g-3" method="post">
                        ...
                        <div class="col-12">
                           <label for="inputName" class="form-label">Soyad</label>
                           <input type="text" class="form-control" id="inputName" name="surname" >
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                           <label for="inputEmail" class="form-label">Telefon Numarası</label>
                        ...
                        <div class="col-12 col-lg-12">
                           <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" name="check" id="flexCheckChecked" checked>
                        ...
                        <div class="col-12 col-lg-12 text-center">
                           <p class="mb-0">Zaten hesabın var mı? <a href="<?=base_url()?>/login">Giriş Yap</a></p>
                        </div>
                     </form>
                  </div>
               </div>
